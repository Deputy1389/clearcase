...
// ---------------------------------------------------------------------------
// useUpload — upload orchestration, camera/file picking, case insight polling
// ---------------------------------------------------------------------------
...
export interface UseUploadCallbacks {
...
export interface UseUploadReturn {
  ...
  callbacks: React.MutableRefObject<UseUploadCallbacks>;
}
...
export function useUpload(deps: UseUploadDeps): UseUploadReturn {
  ...
  // Ref for callbacks that depend on App.tsx / other hooks (breaks circular deps).
  const callbacks = useRef<UseUploadCallbacks>({
