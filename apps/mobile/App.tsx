...
function App() {
  ...
  const plusEnabled = controller.me?.entitlement?.isPlus ?? false;
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.safe}>
        ...
        >
          ...
          {screen === "home" ? (
            <HomeScreen
              navigation={{ screen, setScreen, goBack, postLanguageScreen, setPostLanguageScreen, setDrawerOpen }}
              cases={{ cases, setCases, selectedCaseId, setSelectedCaseId, selectedCase, setSelectedCase, selectedCaseSummary: cases.find((row) => row.id === selectedCaseId) ?? null, latestCase: cases[0] ?? null, filteredCases, caseSearch, setCaseSearch, caseFilter, setCaseFilter, caseAssets, setCaseAssets, loadingCaseAssets, setLoadingCaseAssets, loadingDashboard, loadingCase, creatingCase, savingProfile, refreshing, userFirstName, me, setMe, profileName, setProfileName, profileZip, setProfileZip, newCaseTitle, setNewCaseTitle, loadDashboard, loadCase, loadCaseAssetsForSelectedCase, createCaseWithTitle, saveProfile, refreshWorkspace, reconnectWorkspace }}
              upload={{ uploading, setUploading, uploadStage, setUploadStage, uploadDescription, setUploadDescription, uploadTargetCaseId, setUploadTargetCaseId, uploadCaseTitle, setUploadCaseTitle, uploadSheetOpen, setUploadSheetOpen, latestContextReuseSourceCaseId, setLatestContextReuseSourceCaseId, uploadStatusText, uploadAssets, uploadDocument, uploadFromCamera, beginFileUpload, beginCameraUpload, homeUploadFlow, openUploadSheetForCase, waitForCaseInsight }}
              paywall={{ paywallConfig, planTier, setPlanTier, plusEnabled, startingCheckout, planSheetOpen, setPlanSheetOpen, startPlusCheckout, openPaywall, promptPlusUpgrade, loadPaywallConfigState }}
              ui={{ language, setLanguage, applyLanguageFromSettings, styles, palette, offlineMode, showBanner, hapticTap }}
              auth={{ email, accountInitials, completion, signOut }}
              helpers={{ localizedCaseStatus, formatUploadStage, titleize, fmtDate, fmtDateTime, manualCategoryLabel, casePriorityLevel, casePriorityLabel, severityLabel, severitySummary }}
            />
          ) : null}
          ...
          {screen === "workspace" ? (
            <WorkspaceScreen
              ...
              ui={{ language, setLanguage, applyLanguageFromSettings, styles, palette, offlineMode, showBanner, hapticTap }}
              auth={{ email, accountInitials, completion, signOut }}
              workspace={{ workspaceSeverity, workspaceSummaryText, workspaceSectionMeta, workspaceSectionOpen, toggleWorkspaceSection, workspaceChecklistItems, premiumStepSummaryLine, caseWatchEnabled, savingWatchMode, toggleCaseWatchMode, weeklyCheckInStatus, weeklyCheckInAction, watchMicroEvents, packetShareStatusLine, caseContextDraft, setCaseContextDraft, savingCaseContext, saveCaseContextForSelectedCase, classificationSheetOpen, setClassificationSheetOpen, classificationDraft, setClassificationDraft, savingClassification, openManualCategoryPicker, saveManualCategoryForSelectedCase, loadingPlainMeaning, openPlainMeaningTranslator, lawyerSummaryOpen, setLawyerSummaryOpen, lawyerReadySummary, shareLawyerReadySummary, emailLawyerReadySummary, intakeModalOpen, setIntakeModalOpen, intakeDraft, setIntakeDraft, intakeCompleteness, stepProgressMap, setStepProgress, intakeSectionLabel, intakePlaceholder, stepGroupLabel, premiumActionSteps, groupedPremiumSteps, evidenceCompleteness, costSavingIndicator, consultLinks, loadingConsultLinks, creatingConsultLink, disablingConsultToken, createConsultPacketShareLink, disableConsultPacketShareLink, assetViewerOpen, setAssetViewerOpen, assetViewerAsset, assetViewerUrl, assetViewerLoading, assetViewerIsPdf, assetViewerIsImage, assetViewerRenderUrl, assetViewerPdfPage, setAssetViewerPdfPage, assetViewerPdfZoom, setAssetViewerPdfZoom, assetViewerImageZoom, setAssetViewerImageZoom, assetViewerImagePan, setAssetViewerImagePan, openAssetAccess, closeAssetViewer, openViewerUrlExternally }}
              push={{ pushEnabled, pushQuietHoursEnabled, savingPushPreferences, togglePushNotifications, togglePushQuietHours }}
              legal={{ legalReturnScreen, setLegalReturnScreen }}
              helpers={{ localizedCaseStatus, formatUploadStage, titleize, fmtDate, fmtDateTime, manualCategoryLabel, casePriorityLevel, casePriorityLabel, severityLabel, severitySummary }}
            />
          ) : null}
